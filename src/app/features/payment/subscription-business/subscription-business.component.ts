...
@Component({
  selector: 'app-subscription-business',
  standalone: true,
    ...
    <div class="flow-page-shell">
      <div class="flow-page-content" style="max-width: 900px;">
        <div class="glass" style="border-radius: 28px; padding: 28px;">
          ...
          <h1 style="margin:0 0 10px; font-size: clamp(1.8rem, 3vw, 2.4rem); color: var(--text-primary);">FlowBoard Business</h1>
          <p style="margin:0 0 18px; color: var(--text-secondary);">Enterprise controls and unlimited scale for advanced teams.</p>
...
export class SubscriptionBusinessComponent implements OnInit {
